...
import { Activity, AlertTriangle, Play, Square, Zap, AlertOctagon, Network, ScrollText, BarChart3, Flame, BookOpen, FileText, Shield, Rocket, TrendingUp, Bell, Phone, LayoutGrid, Globe, Grid3X3, MessageSquare, Heart, ClipboardList, FileCheck, Crosshair } from 'lucide-react'
      ...
      <div className="px-4 lg:px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <nav className="flex items-center gap-1 ml-2">
            ...
            <Link to="/oncall" className={`flex items-center gap-1 px-3 py-1 rounded-md text-xs font-medium transition-colors ${location.pathname === '/oncall' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:text-gray-200'}`}>
              <Phone className="w-3 h-3" /> On-Call
            </Link>
            <Link to="/builder" className={`flex items-center gap-1 px-3 py-1 rounded-md text-xs font-medium transition-colors ${location.pathname === '/builder' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:text-gray-200'}`}>
            ...
            <Link to="/heatmap" className={`flex items-center gap-1 px-3 py-1 rounded-md text-xs font-medium transition-colors ${location.pathname === '/heatmap' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:text-gray-200'}`}>
              <Grid3X3 className="w-3 h-3" /> Heatmap
            </Link>
            <Link to="/health" className={`flex items-center gap-1 px-3 py-1 rounded-md text-xs font-medium transition-colors ${location.pathname === '/health' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:text-gray-200'}`}>
              <Heart className="w-3 h-3" /> Health
            </Link>
            <Link to="/notifications" className={`flex items-center gap-1 px-3 py-1 rounded-md text-xs font-medium transition-colors ${location.pathname === '/notifications' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:text-gray-200'}`}>
            ...
            <Link to="/impact" className={`flex items-center gap-1 px-3 py-1 rounded-md text-xs font-medium transition-colors ${location.pathname === '/impact' ? 'bg-gray-700 text-white' : 'text-gray-400 hover:text-gray-200'}`}>
              <Crosshair className="w-3 h-3" /> Impact
            </Link>
